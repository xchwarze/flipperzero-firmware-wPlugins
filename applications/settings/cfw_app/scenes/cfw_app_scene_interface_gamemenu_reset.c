...
static void
    cfw_app_scene_interface_gamemenu_reset_dialog_callback(DialogExResult result, void* context) {
    CfwApp* app = context;
...
void cfw_app_scene_interface_gamemenu_reset_on_enter(void* context) {
    ...
    dialog_ex_set_header(dialog_ex, "Reset Game Menu Apps?", 64, 10, AlignCenter, AlignCenter);
    ...
    dialog_ex_set_result_callback(
        dialog_ex, cfw_app_scene_interface_gamemenu_reset_dialog_callback);
