...
const UFZ::ButtonPanel&
    UFZ::ButtonPanel::addLabel(uint16_t x, uint16_t y, Font font, const char* label)
        const noexcept {
...
const UFZ::ButtonPanel&
    UFZ::ButtonPanel::addIcon(uint16_t x, uint16_t y, const Icon* icon) const noexcept {
...
const UFZ::DialogEx&
    UFZ::DialogEx::setResultCallback(DialogExResultCallback callback) const noexcept {
...
const UFZ::DialogEx&
    UFZ::DialogEx::setIcon(uint8_t x, uint8_t y, const Icon* icon) const noexcept {
...
const UFZ::Popup&
    UFZ::Popup::setHeader(const char* text, uint8_t x, uint8_t y, Align horizontal, Align vertical)
        const noexcept {
...
const UFZ::Popup&
    UFZ::Popup::setText(const char* text, uint8_t x, uint8_t y, Align horizontal, Align vertical)
        const noexcept {
...
void UFZ::TextInput::setValidator(TextInputValidatorCallback callback, void* context)
    const noexcept {
...
void UFZ::VariableItemList::setEnterCallback(VariableItemListEnterCallback callback, void* context)
    const noexcept {
...
const UFZ::Widget&
    UFZ::Widget::addIconElement(uint8_t x, uint8_t y, const Icon* icon) const noexcept {
