...
static void flip_social_callback_draw_compose(Canvas* canvas, void* model) {
    ...
    char* message =
        app_instance->pre_saved_messages.messages[flip_social_pre_saved_message_clicked_index];
    ...
    case ActionPrev:
        ...
        for(uint32_t i = flip_social_pre_saved_message_clicked_index;
...
static void flip_social_callback_draw_login(Canvas* canvas, void* model) {
    ...
    if(!flip_social_sent_login_request) {
        ...
        flip_social_login_success = flipper_http_post_request_with_headers(
            "https://www.flipsocial.net/api/login/",
            "{\"Content-Type\":\"application/json\"}",
            buffer);
        fhttp.state = RECEIVING;
    }
        ...
        if(fhttp.state == IDLE && fhttp.received_data != NULL) {
            ...
            if(strstr(fhttp.received_data, "[SUCCESS]") != NULL ||
               strstr(fhttp.received_data, "User found") != NULL) {
                ...
                strstr(
                    fhttp.received_data, "[ERROR] Not connected to Wifi. Failed to reconnect.") !=
                NULL) {
                canvas_clear(canvas);
...
static void flip_social_callback_draw_register(Canvas* canvas, void* model) {
    ...
    if(!flip_social_sent_register_request) {
        ...
        flip_social_register_success = flipper_http_post_request_with_headers(
            "https://www.flipsocial.net/api/register/",
            "{\"Content-Type\":\"application/json\"}",
            buffer);
...
static void flip_social_callback_submenu_choices(void* context, uint32_t index) {
    ...
    case FlipSocialSubmenuComposeIndexAddPreSave:
        uart_text_input_set_header_text(
            app->text_input_logged_in_compose_pre_save_input, "Enter your message:");
    ...
    default:
        ...
        flip_social_pre_saved_message_clicked_index =
            index - FlipSocialSubemnuComposeIndexStartIndex;
...
static void
    ...
    case 0: // Input SSID
        ...
        uart_text_input_set_header_text(
            app->text_input_logged_out_wifi_settings_ssid, "Enter SSID");
        uart_text_input_set_result_callback(
    ...
    case 1: // Input Password
        ...
        uart_text_input_set_header_text(
            app->text_input_logged_out_wifi_settings_password, "Enter Password");
        uart_text_input_set_result_callback(
...
static void flip_social_text_input_logged_out_login_item_selected(void* context, uint32_t index) {
    ...
    case 0: // Input Username
        ...
        uart_text_input_set_header_text(
            app->text_input_logged_out_login_username, "Enter Username");
        uart_text_input_set_result_callback(
    ...
    case 1: // Input Password
        ...
        uart_text_input_set_header_text(
            app->text_input_logged_out_login_password, "Enter Password");
        uart_text_input_set_result_callback(
...
static void
    ...
    case 0: // Input Username
        ...
        uart_text_input_set_header_text(
            app->text_input_logged_out_register_username, "Enter Username");
        uart_text_input_set_result_callback(
    ...
    case 1: // Input Password
        ...
        uart_text_input_set_header_text(
            app->text_input_logged_out_register_password, "Enter Password");
        uart_text_input_set_result_callback(
    ...
    case 2: // Input Password 2
        ...
        if(app->register_password_2_logged_out &&
           strlen(app->register_password_2_logged_out) > 0) {
            strncpy(
                app->register_password_2_logged_out_temp_buffer,
                app->register_password_2_logged_out,
        ...
        uart_text_input_set_header_text(
            app->text_input_logged_out_register_password_2, "Enter Password Again");
        uart_text_input_set_result_callback(
...
static void
    ...
    case 0: // Input SSID
        ...
        uart_text_input_set_header_text(
            app->text_input_logged_in_wifi_settings_ssid, "Enter SSID");
        uart_text_input_set_result_callback(
    ...
    case 1: // Input Password
        ...
        uart_text_input_set_header_text(
            app->text_input_logged_in_wifi_settings_password, "Enter Password");
        uart_text_input_set_result_callback(
...
static void flip_social_logged_in_profile_change_password_updated(void* context) {
    ...
    if(!flipper_http_post_request_with_headers(
           "https://www.flipsocial.net/api/change-password/",
           "Content-Type: application/json",
           payload)) {
...
static void flip_social_text_input_logged_in_profile_item_selected(void* context, uint32_t index) {
    ...
    case 1: // Change Password
        ...
        uart_text_input_set_header_text(
            app->text_input_logged_in_change_password, "Enter New Password");
        uart_text_input_set_result_callback(
