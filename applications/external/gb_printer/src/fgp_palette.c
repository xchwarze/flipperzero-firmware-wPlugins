...
static struct palette palettes[] = {
    ...
    {"DMG",
     "dmg",
     {{0x9b, 0xbc, 0x0f}, {0x77, 0xa1, 0x12}, {0x30, 0x62, 0x30}, {0x0f, 0x38, 0x0f}}},
    {"GBP",
     "gbp",
    ...
    {"GBL",
     "gbli",
     {{0x1d, 0xde, 0xce}, {0x19, 0xc7, 0xb3}, {0x16, 0xa5, 0x96}, {0x0b, 0x7a, 0x6d}}},
    {"GBCJP",
     "gbcjp",
...
char* palette_name_get(unsigned int idx) {
    if(idx > palette_count_get()) return NULL;
