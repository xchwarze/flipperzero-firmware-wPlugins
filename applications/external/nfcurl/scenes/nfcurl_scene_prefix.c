...
const char* prefix_names[] =
    {"None", "http://", "https://", "tel:", "mailto:", "ftp://", "sftp://", "smb://", "telnet://"};

const char prefixes[] = {0, 3, 4, 5, 6, 0x0d, 0x0a, 0x0b, 0x10};

static void
    nfcurl_scene_prefix_button_menu_callback(void* context, int32_t index, InputType type) {
