...
static void
    nfcurl_scene_created_widget_callback(GuiButtonType result, InputType type, void* context) {
...
void nfcurl_scene_created_on_enter(void* context) {
    ...
    widget_add_text_box_element(
        app->widget, 0, 0, 128, 23, AlignCenter, AlignCenter, "NFC Device Created", false);
    widget_add_text_box_element(
        app->widget,
        0,
        26,
    ...
    widget_add_button_element(
        app->widget, GuiButtonTypeLeft, "Edit", nfcurl_scene_created_widget_callback, app);
    widget_add_button_element(
        app->widget, GuiButtonTypeRight, "Use", nfcurl_scene_created_widget_callback, app);
    widget_add_button_element(
        app->widget, GuiButtonTypeCenter, "Options", nfcurl_scene_created_widget_callback, app);
