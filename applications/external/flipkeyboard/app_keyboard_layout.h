...
KeystrokeSelectorKey shift_keys[] = {
    ...
    {},
    //
    {.code = HID_KEYBOARD_1 | KEY_MOD_LEFT_SHIFT, .ch = '!', .icon = NULL},
    {.code = HID_KEYBOARD_2 | KEY_MOD_LEFT_SHIFT, .ch = '@', .icon = NULL},
    {.code = HID_KEYBOARD_3 | KEY_MOD_LEFT_SHIFT, .ch = '#', .icon = NULL},
    {.code = HID_KEYBOARD_4 | KEY_MOD_LEFT_SHIFT, .ch = '$', .icon = NULL},
    {.code = HID_KEYBOARD_5 | KEY_MOD_LEFT_SHIFT, .ch = '%', .icon = NULL},
    {.code = HID_KEYBOARD_6 | KEY_MOD_LEFT_SHIFT, .ch = '^', .icon = NULL},
    {.code = HID_KEYBOARD_7 | KEY_MOD_LEFT_SHIFT, .ch = '&', .icon = NULL},
    {.code = HID_KEYBOARD_8 | KEY_MOD_LEFT_SHIFT, .ch = '*', .icon = NULL},
    {.code = HID_KEYBOARD_9 | KEY_MOD_LEFT_SHIFT, .ch = '(', .icon = NULL},
    {.code = HID_KEYBOARD_0 | KEY_MOD_LEFT_SHIFT, .ch = ')', .icon = NULL},
    {},
    {},
    //
    {},
    ...
    {.code = HID_KEYBOARD_COMMA | KEY_MOD_LEFT_SHIFT, .ch = '<', .icon = NULL},
    {.code = HID_KEYBOARD_DOT | KEY_MOD_LEFT_SHIFT, .ch = '>', .icon = NULL},
    {.code = HID_KEYBOARD_SLASH | KEY_MOD_LEFT_SHIFT, .ch = '?', .icon = NULL},
    //
    {},
    {},
    {},
    ...
    {},
    {},
    {.code = HID_KEYBOARD_BACKSLASH | KEY_MOD_LEFT_SHIFT, .ch = '|', .icon = NULL},
    {.code = HID_KEYBOARD_SEMICOLON | KEY_MOD_LEFT_SHIFT, .ch = ':', .icon = NULL},
    {.code = HID_KEYBOARD_GRAVE_ACCENT | KEY_MOD_LEFT_SHIFT, .ch = '~', .icon = NULL},
    //
    {},
    {},
    {},
    {},
    {.code = HID_KEYBOARD_MINUS | KEY_MOD_LEFT_SHIFT, .ch = 0, .icon = &I_underscore_5x10},
    {.code = HID_KEYBOARD_EQUAL_SIGN | KEY_MOD_LEFT_SHIFT, .ch = '+', .icon = NULL},
    {},
    {},
    {},
    {},
...
KeystrokeSelectorKey keys[] = {
    {.code = HID_KEYBOARD_F1, .ch = 0, .icon = &I_f1_5x10},
    {.code = HID_KEYBOARD_F2, .ch = 0, .icon = &I_f2_5x10},
    {.code = HID_KEYBOARD_F3, .ch = 0, .icon = &I_f3_5x10},
    {.code = HID_KEYBOARD_F4, .ch = 0, .icon = &I_f4_5x10},
    {.code = HID_KEYBOARD_F5, .ch = 0, .icon = &I_f5_5x10},
    {.code = HID_KEYBOARD_F6, .ch = 0, .icon = &I_f6_5x10},
    {.code = HID_KEYBOARD_F7, .ch = 0, .icon = &I_f7_5x10},
    {.code = HID_KEYBOARD_F8, .ch = 0, .icon = &I_f8_5x10},
    {.code = HID_KEYBOARD_F9, .ch = 0, .icon = &I_f9_5x10},
    {.code = HID_KEYBOARD_F10, .ch = 0, .icon = &I_f10_5x10},
    {.code = HID_KEYBOARD_F11, .ch = 0, .icon = &I_f11_5x10},
    {.code = HID_KEYBOARD_F12, .ch = 0, .icon = &I_f12_5x10},
