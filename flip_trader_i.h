...
static FlipTraderApp *flip_trader_app_alloc()
{
    ...
    // Submenu
    if (!easy_flipper_set_submenu(&app->submenu_main, FlipTraderViewMainSubmenu, "FlipTrader v1.0", easy_flipper_callback_exit_app, &app->view_dispatcher))
    {
        return NULL;
    }
